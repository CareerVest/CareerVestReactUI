...
//     SubscriptionPlan[]
//   >([]);
//   const [postPlacementPlans, setPostPlacementPlans] = useState<
//     PostPlacementPlan[]
//   >([]);
...
//       const [recruitersData, subscriptionPlansData, postPlacementPlansData] =
//         await Promise.all([
//           getRecruiters(),
//           getSubscriptionPlans(),
//           getPostPlacementPlans(),
...
//   ) => {
//     const name = event.target.name as keyof ClientFormData;
//     setClientData((prevData) => ({
//       ...prevData,
...
//                 <Grid item xs={12} sm={6} sx={{ mb: 1 }}>
//                   <FormControl fullWidth size="small">
//                     <InputLabel id="SubscriptionPlanID-label">
...
//                 <Grid item xs={12} sm={6} sx={{ mb: 1 }}>
//                   <FormControl fullWidth size="small">
//                     <InputLabel id="PostPlacementPlanID-label">
...
//                         <MenuItem
//                           key={plan.PostPlacementPlanID}
//                           value={plan.PostPlacementPlanID}
//                         >
//                           {plan.PlanName}
//                         </MenuItem>
//                       ))}
